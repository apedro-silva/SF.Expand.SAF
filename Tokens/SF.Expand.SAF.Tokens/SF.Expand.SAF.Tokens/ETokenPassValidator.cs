...
{
	public class ETokenPassValidator : ITokenValidator
	{
		...
		public OperationResult ChallengeRequest(string tokenInternalID, string dataEntropy, out string Challenge)
		{
			throw new NotImplementedException();
		}
